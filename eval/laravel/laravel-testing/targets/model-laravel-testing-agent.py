#!/usr/bin/env python3
"""Model-invoking target agent for the laravel-testing outcome evaluation."""
...
def main() -> int:
    ...
    if skill_path and Path(skill_path).is_file():
        ...
        system_prompt = (
            "You are an expert testing engineer evaluating Laravel test suites (Pest / PHPUnit). "
        ...
        system_prompt = (
            "You are a helpful software engineering assistant evaluating Laravel test code. "
            f"{format_instruction}"
        )
