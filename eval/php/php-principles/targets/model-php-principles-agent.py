#!/usr/bin/env python3
"""Model-invoking target agent for the php-principles outcome evaluation."""
...
def main() -> int:
    ...
    if skill_path and Path(skill_path).is_file():
        ...
        system_prompt = (
            "You are an expert engineer evaluating PHP software engineering principles. "
        ...
        system_prompt = (
            "You are a helpful software engineering assistant evaluating PHP code design. "
            f"{format_instruction}"
        )
