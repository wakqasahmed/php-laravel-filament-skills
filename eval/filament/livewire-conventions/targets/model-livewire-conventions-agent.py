#!/usr/bin/env python3
"""Model-invoking target agent for the livewire-conventions outcome evaluation."""
...
def main() -> int:
    ...
    if skill_path and Path(skill_path).is_file():
        ...
        system_prompt = (
            "You are an expert engineer evaluating Livewire component architecture and conventions. "
        ...
        system_prompt = (
            "You are a helpful software engineering assistant evaluating Livewire code. "
            f"{format_instruction}"
        )
