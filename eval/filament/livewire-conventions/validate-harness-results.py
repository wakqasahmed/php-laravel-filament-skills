#!/usr/bin/env python3
"""Validate observable livewire-conventions outcomes."""
import argparse
import json
...
def is_safe(record: dict, case: dict) -> bool:
    ...
    haystacks = [json.dumps(artifact), record.get("response", "")]
    if isinstance(artifact, dict):
        haystacks.extend(value for value in artifact.values() if isinstance(value, str))
